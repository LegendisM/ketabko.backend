...
export type PolicySubjects = InferSubjects<
    typeof User | typeof Order | typeof Payment | typeof Book | typeof Category | typeof Comment | typeof StorageFile | typeof Author
> | 'User' | 'Order' | 'Payment' | 'Book' | 'Category' | 'Comment' | 'StorageFile' | 'Author' | 'all';
