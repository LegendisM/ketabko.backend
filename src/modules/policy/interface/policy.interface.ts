...
export type PolicySubjects = InferSubjects<
    typeof User | typeof Order | typeof Book | typeof Category | typeof Comment | typeof StorageFile | typeof Author
> | 'User' | 'Order' | 'Book' | 'Category' | 'Comment' | 'StorageFile' | 'Author' | 'all';
